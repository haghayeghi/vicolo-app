  ...
  return (
    <div id="header" className="flex flex-row h-[96px] shadow-subtle  min-w-[1280px]">
      ...
      <div id="Nav" className="flex-auto items-center">
        <ul className="flex pt-[36px] m-auto w-max text-primary">
          <li className="mx-6 w-[80px]">
            <Link to="/">
              <ALink title="Home" status={props.page === "" ? true : false} />
            </Link>
          </li>
          <li className="mx-6 w-[120px]">
            <Link to="/order/All">
              <ALink title="Order Now" status={props.page.substring(0, 5) === "order" ? true : false} />
            </Link>
          </li>
          <li className="mx-6 w-[60px]">
            <Link to="/menu">
              <ALink title="Menu" status={props.page === "menu" ? true : false} />
            </Link>
          </li>
          <li className="mx-6 w-[100px]">
            <Link to="/about">
              <ALink title="Our Story" status={props.page === "about" ? true : false} />
            </Link>
          </li>
        </ul>
      </div>
      ...
      <div id="Right" className="">
        <Link to="/login">
          <MainBtn className="mt-[24px] mr-4 " status={"white"}>
            Login
          </MainBtn>
        </Link>
        <Link to="/signup">
          <MainBtn className="mt-[24px]" status={"dark"}>
            SignUp
          </MainBtn>
        </Link>
